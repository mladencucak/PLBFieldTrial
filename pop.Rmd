...
ggplot() +
  ...
  guides(fill=guide_legend(nrow=3,byrow=TRUE,title.position = "top"),
         color=guide_legend(nrow=6,byrow=TRUE,title.position = "top"))+

  ggsave(filename= here::here("results", "gen", "freq", "Genotype and DPC per sampling horisontal.png"),
         width = 10, height =4.2, dpi = 620)
