...
## Yield analysis
Here we present the analysis of the impact of the fungicide programme, variety and year on the marketable yield. 
## Load packages
...
```{r}
ggboxplot(yld, x = "variety", y = "marketable",facet.by = "year",   color = "treatment",palette =  "Dark2")
...
Merge bothe data sets together. 
```{r}
d2016$year <-  "2016"
d1 <- 
...
dodging <-  .8
 ...
 p_fin <- 
  ...
  mutate(
    ...
    line_positions = ifelse(year == 2016 & variety == "SM", 5.5, line_positions)
  ) %>%
